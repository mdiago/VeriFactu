...
namespace VeriFactu.Business
{
    ...
    /// <summary>
    /// Representa una entrada de factura en el
    /// sistema con incidencia técnica.
    /// </summary>
    public class InvoiceEntryTI : InvoiceEntry
    {
        ...
        /// Constructor.
        /// </summary>
        /// <param name="invoice">Instancia de factura de entrada
        /// en el sistema con incidencia técnica.</param>
        public InvoiceEntryTI(Invoice invoice) : base(invoice)
        {
        }
