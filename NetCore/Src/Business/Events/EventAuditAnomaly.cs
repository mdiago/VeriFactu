...
namespace VeriFactu.Business.Events
{
    ...
    /// <summary>
    /// Representa una anomalía detectada en un registro
    /// de facturación.
    /// </summary>
    internal class EventAuditAnomaly
    {
        ...
        /// <summary>
        /// Información adicional sobre la anomalía.
        /// </summary>
        internal string Details { get; set; }

        /// <summary>
        /// Registro de facturación en el que se ha
        /// detectado la anomalía.
        /// </summary>
        internal Registro Record { get; set; }
