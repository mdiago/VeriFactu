...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// <summary>
    /// Datos identificativos de un registro de evento.
    /// </summary>
    ...
    public class RegEvento
    {
        ...
        {
            return $"{TipoEvento}: {FechaHoraHusoEvento} ({HuellaEvento})";
        }
