...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// <summary>
    /// Datos de una anomalía detectada en los registros de facturación.
    /// </summary>
    [XmlType(Namespace = Namespaces.NamespaceSf)]
    public class DeteccionAnomaliasRegFacturacion
    {
        ...
        /// <summary>
        /// Identificación del registro de facturación en el que se ha detectado la anomalía.
        /// Valor esperado:
        /// <para>Datos identificativos de la factura expedida asociada al registro de facturación anómalo. </para>
        /// <para>Propiedad opcional. </para>
        /// </summary>        
        [XmlElement(Order = 2)]
        public IDFacturaExpedida RegistroFacturacionAnomalo { get; set; }
        ...
        {
            return $"{TipoAnomalia}: {RegistroFacturacionAnomalo}";
        }
