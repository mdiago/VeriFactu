...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// <summary>
    /// Datos de identificación y huella de una factura expedida.
    /// </summary>
    [XmlType(Namespace = Namespaces.NamespaceSf)]
    public class IDFacturaExpedidaHuella
    {
        ...
        /// Valor esperado:
        /// <para>Texto con una longitud máxima de 60 caracteres. </para>
        /// </summary>
        [XmlElement(Order = 1)]
        ...
        /// Valor esperado:
        /// <para>Fecha en formato DD-MM-YYYY. </para>
        /// </summary>
        [XmlElement(Order = 2)]
        ...
        {
            return $"{IDEmisorFactura}: {NumSerieFactura} ({FechaExpedicionFactura}) - {Huella}";
        }
