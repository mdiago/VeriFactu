...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// <summary>
    /// Datos de una persona física o jurídica española con NIF asociado.
    /// </summary>
    ...
    public class PersonaFisicaJuridicaES
    {
        ...
        /// <summary>
        /// Nombre y apellidos o razón social del obligado a la emisión.
        /// Valor esperado:
