...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// <summary>
    /// Agrupación de eventos por tipo.
    /// </summary>
    [XmlType(Namespace = Namespaces.NamespaceSf)]
    public class TipoEventoAgr
    {
        ...
        /// <summary>
        /// Número de eventos generados del tipo indicado.
        /// Valor esperado:
        /// <para>Cadena numérica de 1 a 4 dígitos. </para>
        /// </summary>
        [XmlElement(Order = 1)]
        public string NumeroDeEventos { get; set; }
        ...
        {
            return $"{TipoEvento}: {NumeroDeEventos}";
        }
