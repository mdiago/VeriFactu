...
namespace VeriFactu.Xml.Factu.Evento
{
    ...
    /// Registro de evento.
    /// </summary>
    [XmlRoot("RegistroEvento", Namespace = Namespaces.NamespaceSf)]
    public class RegistroEvento
    {
        ...
        /// <summary>
        /// Identificador de la versión del esquema utilizado.
        /// Valores esperados:
        /// <para>"1.0": Versión 1.0 del esquema de registros de evento. </para>
        /// </summary>
        [XmlElement("IDVersion", Order = 0)]
        public string IDVersion { get; set; }

        /// <summary>
        /// Datos del registro de evento.
        /// Valor esperado:
        /// <para>Información correspondiente al evento generado por el sistema informático. </para>
        /// </summary>
        [XmlElement("Evento", Order = 1)]
